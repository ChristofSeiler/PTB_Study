...
ggplot(tb,aes(x = time_to_delivery_fac, 
  ...
  ggtitle("RGS13")
lo_mock = dplyr::filter(tb, treatment == "mock" & time_to_delivery_fac == "< 10")$mean
lo_h1n1 = dplyr::filter(tb, treatment == "H1N1" & time_to_delivery_fac == "< 10")$mean
hi_mock = dplyr::filter(tb, treatment == "mock" & time_to_delivery_fac == "> 20")$mean
hi_h1n1 = dplyr::filter(tb, treatment == "H1N1" & time_to_delivery_fac == "> 20")$mean
