...
mean(gene_table2$symbol=="No_Symbol_Found")
sum(gene_table2$P.Value < 0.05)
```
...
write.csv(gene_table2,file = "H1N1_vs_Mock_for_Preterm_vs_H1N1_vs_Mock_for_Term_fixed_results.csv")
```
