---
title: "Oligo with Matched Samples"
...
pkgs_needed = c("oligo","limma",
                ...
                "MatchIt",
                "ggfortify","magrittr","statmod","readr","dplyr")
...
Merge with sample information table.
...
sample_table %<>% dplyr::select(ptidno,
                                ...
                                gestage_delivery = gestage_delivery.x,
                                pair,
                                sample_id = SampleID)
```
...
sample_table2 = sapply(file_names_arr,function(file_name) {
