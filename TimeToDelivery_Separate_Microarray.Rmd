...
```{r export_sample_table}
current_filename = strsplit(knitr::current_input(), "\\.")[[1]][1]
write_csv(sample_table,path = paste0(current_filename, ".csv"))
```
...
for(i in 1:length(gene_table_list)) {
  ...
  print(gene_table_subset[,c("logFC","P.Value","adj.P.Val","symbol")])
  cat(separator,names(gene_table_list)[i],separator,"\n\n")
}
```
